...
**The mischievous one** is short and cheeky — a handful of words next to a full
drill, so the two never read as the same kind of ask and the choice is obvious
at a glance.

The mischievous side follows hard rules, because a nudge that gets someone in
trouble is a bad nudge: nothing unsafe, nothing that damages anything, and
nothing that makes another person the punchline or lands them with the
consequences. Every one is something you do to yourself or to your own day.
...
```
src/
  data/tasks.ts        100 exercise/reset drills + 50 short cheeky ones
