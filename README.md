...
Sign-in (phone OTP or Google) is the one networked feature, and it is
deliberately optional — "continue without an account" gives a fully functional,
fully offline app. See `docs/AUTH_SETUP.md`.
...
src/
  ...
  lib/
    auth.ts            phone OTP + Google — stubbed, see docs/AUTH_SETUP.md
...
`123456` for any number. The OTP screen shows a developer-build banner while
