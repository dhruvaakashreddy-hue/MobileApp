...
export const CHAOS_ACTIONS: ChaosAction[] = [
  ...
  c('c51', 'compliment someone\'s choice of mug'),
  c('c52', 'ask a friend for their worst opinion'),
  c('c53', 'challenge someone to a thumb war'),
  c('c54', 'tell someone they have great taste'),
  c('c55', 'do a fake sneeze, very loudly'),
  c('c56', 'ask someone to settle a coin flip'),
  c('c57', 'send a friend a voice note humming'),
  c('c58', 'compliment someone\'s phone wallpaper'),
  c('c59', 'tell a friend they\'re your favourite today'),
  c('c60', 'ask someone to teach you something useless'),
  c('c61', 'do a kind impression of your boss'),
  c('c62', 'give someone a fake award, out loud'),
  c('c63', 'ask a friend their villain name'),
  c('c64', 'compliment someone\'s posture, loudly'),
  c('c65', 'challenge someone to a bad dance-off'),
  c('c66', 'tell someone an undeniable compliment'),
  c('c67', 'ask a friend to describe you badly'),
  c('c68', 'send a friend a photo of your shoe'),
  c('c69', 'say someone\'s name in a dramatic voice'),
  c('c70', 'ask someone to pick your next snack'),
  c('c71', 'compliment the nearest person\'s typing'),
  c('c72', 'offer someone an extremely firm handshake'),
  c('c73', 'tell a friend you\'re plotting something'),
  c('c74', 'challenge someone to hold a plank'),
  c('c75', 'ask someone to rate your joke'),
  c('c76', 'give someone a fake fortune reading'),
  c('c77', 'compliment someone\'s keyboard sounds'),
  c('c78', 'text a friend “you were right”'),
  c('c79', 'ask a friend for a terrible tip'),
  c('c80', 'do a slow-motion wave at someone'),
  c('c81', 'tell someone their outfit means business'),
  c('c82', 'ask someone to guess your age'),
  c('c83', 'challenge someone to name ten fruits'),
  c('c84', 'compliment someone\'s ability to exist'),
  c('c85', 'send a friend a bad screenshot of yourself'),
  c('c86', 'ask someone what animal you\'d be'),
  c('c87', 'make a dramatic entrance into a room'),
  c('c88', 'tell someone you\'re their biggest fan'),
  c('c89', 'ask a friend to invent your theme song'),
  c('c90', 'compliment someone\'s snack choice'),
  c('c91', 'give someone a completely useless fact'),
  c('c92', 'high five someone with both hands'),
  c('c93', 'tell a friend something you appreciate'),
  c('c94', 'challenge someone to say the alphabet backwards'),
  c('c95', 'do a very serious salute at someone'),
  c('c96', 'ask someone to rate your handshake'),
  c('c97', 'compliment someone\'s ability to nap'),
  c('c98', 'text a friend a single question mark'),
  c('c99', 'tell someone they\'re doing better than they think'),
  c('c100', 'ask a friend to pick your next task'),
];
